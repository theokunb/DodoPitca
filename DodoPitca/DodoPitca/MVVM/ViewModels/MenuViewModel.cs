...
namespace DodoPitca.MVVM.ViewModels
{
    ...
    {
        private ObservableCollection<CustomTovarViewModel> tovars = new ObservableCollection<CustomTovarViewModel>();
        private ObservableCollection<CustomTovarViewModel> newAndHot = new ObservableCollection<CustomTovarViewModel>();
        ...
        {
            NewAndHot.Add(new CustomTovarViewModel()
            {
        ...
        {
            tovars.Add(new CustomTovarViewModel()
            {
